...
final class ReceivePathCodecTests: XCTestCase {
  ...
  func testACodec2ReceiveCodecDecodesAtTheSinkRateOnItsFirstFrame() throws {
    ...
    let wire = try sender.encode(
      AudioFrame(
        samples: [Float](repeating: 0.1, count: 3200),
