...
final class NetworkTests: XCTestCase {
  ...
  func testLineSourceDefaultFrameMs() {
    XCTAssertEqual(
      LineSource.defaultFrameMs, 80.0,
  ...
  func testOpusFileSourceDefaultFrameMs() {
    XCTAssertEqual(
      OpusFileSource.defaultFrameMs, 100.0,
  ...
  func testSignallingEncodeStatusCodeWireBytes() {
    ...
    XCTAssertEqual(
      [UInt8](data), [0x81, 0x00, 0x91, 0x04],
  ...
  func testSignallingRoundTripStatusCode() {
    ...
    XCTAssertEqual(
      SignallingReceiver.decodeSignals(data), [0x06],
  ...
  func testSignallingRoundTripProfileComposite() {
    ...
    XCTAssertEqual(
      decoded?.first.map { $0 - Int(signallingPreferredProfile) },
  ...
  func testSignallingReceiveDispatchDeliversInts() {
    ...
    XCTAssertEqual(
      receiver.received, [0x04, composite],
